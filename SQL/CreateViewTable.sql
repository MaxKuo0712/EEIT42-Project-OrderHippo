...
order by meal.MEAL_CATEGORY_NAME
...
select YEAR, MONTH, CONCAT(YEAR, '_', MONTH) as 'YEAR_MONTH', REVENUE_OF_MONTH
from (
	SELECT EXTRACT(YEAR from o.CREATE_TIME) as 'YEAR', EXTRACT(MONTH from o.CREATE_TIME) as 'MONTH', 
...
from (
	select 
		CASE 
			WHEN TIMESTAMPDIFF(YEAR, USER_BIRTH, CURRENT_DATE()) BETWEEN 1 and 10 THEN '1-10'
			WHEN TIMESTAMPDIFF(YEAR, USER_BIRTH, CURRENT_DATE()) BETWEEN 11 and 20 THEN '11-20'
			WHEN TIMESTAMPDIFF(YEAR, USER_BIRTH, CURRENT_DATE()) BETWEEN 21 and 30 THEN '21-30'
			WHEN TIMESTAMPDIFF(YEAR, USER_BIRTH, CURRENT_DATE()) BETWEEN 31 and 40 THEN '31-40'
			WHEN TIMESTAMPDIFF(YEAR, USER_BIRTH, CURRENT_DATE()) BETWEEN 41 and 50 THEN '41-50'
			WHEN TIMESTAMPDIFF(YEAR, USER_BIRTH, CURRENT_DATE()) BETWEEN 51 and 60 THEN '51-60'
			WHEN TIMESTAMPDIFF(YEAR, USER_BIRTH, CURRENT_DATE()) BETWEEN 61 and 70 THEN '61-70'
			WHEN TIMESTAMPDIFF(YEAR, USER_BIRTH, CURRENT_DATE()) BETWEEN 71 and 80 THEN '71-80'
			ELSE '80+'
		END as 'AGE_RANGE', COUNT(*) as QTY
	from USER_INFO
	group by 
...
select meal.MEAL_ID, bom.BOM_ID, meal.MEAL_NAME, meal.MEAL_HOT, meal.MEAL_VEGAN, 
	meal.MEAL_IMAGE, meal.MEAL_PRICE, bom.INGREDIENT_ID, bom.INGREDIENT_NAME,
